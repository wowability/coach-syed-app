...
def get_optimal_model(user_prompt):
    ...
    try:
        ...
        router = genai.GenerativeModel("gemini-1.5-flash", system_instruction=router_instruction)
        ...
        return "gemini-1.5-pro" # Default to the smarter model if routing fails
